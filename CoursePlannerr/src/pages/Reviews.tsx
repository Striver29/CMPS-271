    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 409 || err?.code === "23505") {
          ...
          setSubmitError(
            "⚠️ Your review contains inappropriate content and was not submitted.",
          );
        } else {
  ...
  const renderScorePanel = (
    ...
    <div style={card}>
      ...
      >
        ...
        <span style={{ fontSize: 22, color: "var(--muted)", marginBottom: 12 }}>
          /5
        </span>
      </div>
